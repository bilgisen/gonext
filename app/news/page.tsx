    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-2 text-sm text-muted-foreground">
          {filters.category && (
            <span className="px-2 py-1 bg-primary/10 text-primary-foreground/90 rounded">
              Category: {filters.category}
            </span>
          )}
          {filters.tag && (
            <span className="px-2 py-1 bg-secondary/10 text-secondary-foreground/90 rounded">
              Tag: {filters.tag}
            </span>
          )}
          {filters.search && (
            <span className="px-2 py-1 bg-accent/10 text-accent-foreground/90 rounded">
