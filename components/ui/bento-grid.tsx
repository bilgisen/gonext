  ...
  return (
    <div
      className={cn(
        ...
        "lg:grid-cols-12", // 12 sütunlu bento grid
        // Satırlar otomatik boyutlansın, her kart kendi konumunu belirlesin
        className
      )}
      {...props}
    >
      ...
      <Link href={href}>
        <div
          className={cn(
            ...
            // Harici className en sonda olmalı ki dinamik konumlar geçerli olsun
            className
          )}
          {...props}
        >
