...
const FrontCategoryLayoutOne: React.FC<FrontCategoryLayoutOneProps> = ({
  ...
  // Debug log the props
  console.log('FrontCategoryLayoutOne - props:', { category, limit });
  ...
  console.log('FrontCategoryLayoutOne - Raw API response:', data);
  console.log('FrontCategoryLayoutOne - Pages:', data?.pages);
  console.log('FrontCategoryLayoutOne - First page:', data?.pages?.[0]);
  ...
  // Take only the first 5 news items (1 for center, 2 for left, 2 for right)
