...
export default function TrendingArticles({ limit = 5, period = 'daily' }: TrendingArticlesProps) {
  ...
  return (
    <div className="space-y-4 bg-background sticky">
                ...
                <div>
                  ...
                  <div className="flex items-center text-sm text-gray-500 mt-1">
                    ...
                    {article.trending_score != null && article.trending_score !== 0 && (
                      <span className="ml-2 text-xs text-blue-500">(Trend: {article.trending_score})</span>
                    )}
                  </div>
                </div>
              </div>
